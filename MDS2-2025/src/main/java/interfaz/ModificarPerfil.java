...
public class ModificarPerfil extends DatosdePerfil {
	...
	public void Actualizar() {
		...
		usuario u = this._usuario._iUsuario.actualizar(_usuario.u.getID(), this.getNombre().getValue(), this.getDni().getValue(), 
				this.getCorreo().getValue(), this.getNick().getValue(), this.getLogin().getValue(), this.getPassword().getValue());
